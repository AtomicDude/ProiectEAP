...
<html>
<head>
    <link rel = "stylesheet" type = "text/css" href = "<%=request.getContextPath() + "/styles/general_style.css"%>">
    <link rel = "stylesheet" type = "text/css" href = "<%=request.getContextPath() + "/styles/hnavbar_style.css"%>">
    <link rel = "stylesheet" type = "text/css" href = "<%=request.getContextPath() + "/styles/dropdown_style.css"%>">
